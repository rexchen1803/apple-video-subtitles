...
const movieAssetId = "6793695228";
const movieSlug = "2008-forgetting-sarah-marshall";
const markerKey = "sarahzh";
...
function injectOriginal(masterBody, sourceUrl) {
  ...
  else if (body.includes('STABLE-RENDITION-ID="forgetting-sarah-marshall-zh-hans-v1"')) { __captureDone({ body }); }
  else {
